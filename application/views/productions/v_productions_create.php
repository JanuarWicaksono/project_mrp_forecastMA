                ...
                <div class="body table-responsive">
                    <form action="<?php echo base_url('Productions/productionsCreate') ?>" id="productions-form">
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="button" id="btn-forecast-add" class="btn btn-xs btn-info waves-effect"><i class="material-icons">show_chart</i><span>Masukan Peramalan / Forecast</span></button>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group form-float" disabled>
                                <div class="">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="status" type="radio" id="unfinished" value="unfinished" checked/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-line">
                                    <b>Tanggal Mulai</b>
                                    <input type="text" class="datepicker form-control" id="production-date" name="started-at" placeholder="Please choose a date...">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
