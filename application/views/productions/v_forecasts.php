        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Peramalan / <i>Forecasting</i> tahun 2018
                            <small>Metode Peramalan / <i>Forecasting</i> menggunakan <code>Moving Average</code></small>
                        </h2>
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Forecast</th>
                                    <th>Error (Omzet - Forecast)</th>
                                    <th>(Omzet - Forecast)<sup>2</sup></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
